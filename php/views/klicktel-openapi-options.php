...
<div class="wrap">
        ...
        <div style="margin-left:25px;">[openapiform <b>type</b>="meta"]</div>
        <br/>
        
        <b>Available Attributes:</b><br/>
        <ol style="margin-left:40px;">
            <li><b>type</b> defines the type of search to create a form for, supported are: "meta", "yellowpages", "whitepages", "geo" and "invers"</li>
        </ol>
        <br/>
        ...
        <b>Available Attributes:</b><br/>
        <ol style="margin-left:40px;">
            <li><b>type</b> defines the type of search, supported are: "meta", "yellowpages", "whitepages", "geo" and "invers"</li>
            ...
            <li><b>distance</b> distance from location in kilometers (can only be used with searchtype "geo")</li>
            <li><b>trade</b> trade name, lists entries with that trade name (can be used with searchtype "yellowpages")</li>
            <li><b>number</b> phone number, searches for entries with that phone number (can be use with searchtype "invers")</li>
        </ol>
        <br/>
        ...
        <br/>
 		...
 		<div class="wrap">
			...
			<input size="60" name="ck_openapi_key_field" value="<?php echo $key; ?>" type="text" /><br/>
			Debug? (currently <?php echo ($debug==true) ? 'on' : 'off'; ?>)<input type="checkbox" name="ck_openapi_activate_debug" value="1" <?php echo ($debug==true) ? 'checked="checked"' : ''; ?>/>
